/**
 * Lab images: prefer local public/images/ when NEXT_PUBLIC_USE_LOCAL_IMAGES=true
 * (after `npm run sync:images`). Otherwise GitHub raw — works without committing binaries.
 */
