                  ...
                  {navItems.map((item) => (
                    <SheetClose key={item.href} asChild>
                      <Link
                        href={item.href}
                        className={cn(
                          "nav-chip-tech flex items-center rounded-2xl px-3 py-3 text-base font-medium transition-all duration-300 motion-safe:transition-transform motion-safe:active:scale-[0.99]",
                          pathname === item.href
